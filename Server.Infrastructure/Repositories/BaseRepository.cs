...
namespace Server.Infrastructure.Repositories
{
    ...
    public class BaseRepository<T> : IBaseRepository<T> where T : class
    {
        ...
        public virtual async Task<PaginatedDataDTO<T>> GetPaginatedData(int pageNumber, int pageSize, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PaginatedDataDTO<T>> GetPaginatedData(int pageNumber, int pageSize, List<ExpressionFilter> filters, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<PaginatedDataDTO<T>> GetPaginatedData(List<Expression<Func<T, object>>> includeExpressions, int pageNumber, int pageSize, CancellationToken cancellationToken = default)
        {
            var query = _dbContext.Set<T>()
                .Skip((pageNumber - 1) * pageSize)
                .Take(pageSize)
        ...
        public async Task<PaginatedDataDTO<T>> GetPaginatedData(int pageNumber, int pageSize, List<ExpressionFilter> filters, string sortBy, string sortOrder, CancellationToken cancellationToken = default)
        {
            var query = _dbContext.Set<T>().AsNoTracking();
